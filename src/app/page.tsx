...
import { Moon, Sun, Menu, X, Mail, Phone, MapPin, ExternalLink, Github, Linkedin, Twitter, ArrowRight, Calendar, MapPin as LocationIcon, Briefcase, Award, CheckCircle, Code, Database, Smartphone, Settings, GraduationCap, Rocket, Shield, Trophy, Home as HomeIcon, User, Wrench, Briefcase as WorkIcon, BookOpen, Star, MessageSquare } from 'lucide-react';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Remove scroll-based section detection since we're not scrolling
    // Keep skills visibility animation for when skills section is active
  ...
  const changeSection = (sectionId: string) => {
    ...
    setIsMenuOpen(false);
    // Reset skills visibility when switching away from skills
    if (sectionId !== 'skills') {
  ...
  // Define sections for slide bar
  const slideBarSections = [
    ...
    { id: 'experience', label: 'Experience', icon: <WorkIcon className="w-4 h-4" /> },
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              &copy; 2024 Arkar Yan. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
